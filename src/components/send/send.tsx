...
export default function Send({ history }: HistoryPushProp) {
  ...
  async function send() {
    ...
    // this is a really lazy solution. We send a hookout for each line.. Alternative is to modify blindmixer-lib a bit to allow Hookout to have multiple output addresses (for this reason?) (TODO?)
    let transferHash;
