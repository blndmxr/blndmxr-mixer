  ...
  return (
    <div className="custom-navbar">
      ...
      <NavLink
        path={pathname}
        to="/receive"
        className={pathname === '/receive/lightning' ? 'prev-non-active-nav' : pathname === '/send' ? 'post-non-active-nav' : ''}
      >
      ...
      {props.isMobile ? (
        ...
        <div>
          <div className={pathname === '/receive/lightning' ? 'post-non-active-nav' : ''}>
            <SyncBtn />
          </div>
        </div>
      )}
