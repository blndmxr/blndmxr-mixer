...
export default class Database extends EventEmitter {
    ...
    for (const claimable of claimables) {
      ...
      if (check) {
        try {
          ...
          console.log('[sync:blindmixer-claimables] checking claimable statuses: ', claimable.hash);
          await this.requestStatuses(claimable.hash);
          console.log('[sync:blindmixer-claimables] checking claimable claims: ', claimable.hash);
  ...
  async syncNested(emptySyncedCoinsPrevious?: Docs.Coin[]) {
    ...
    for (const checkCoin of Unspent) {
      ...
      console.log('[sync:blindmixer-coins] checking coins for status: ', checkCoin.owner);
